...
--
-- Host: localhost:3306
-- Waktu pembuatan: 19 Okt 2023 pada 10.12
-- Versi server: 5.7.33
-- Versi PHP: 8.1.3
...
('9a594d00-6227-44f5-ac0b-468052a04464', 'Pengelola Taman Nasional', 'admin', '$2y$10$hHikEfvy/oX3y4ir4gjkSOG3M7OsTWI56zJU30CEbVqGxaUhzgwtC', '12345', 'app/user/1697083344-mlSrt.png', '2023-10-12 04:02:40', '2023-10-11 21:02:40'),
('9a594e0f-3eb1-4e95-936e-67edc994bd90', 'Pengelola Wisata', 'admin', '$2y$10$NKyvunlrncQGtj7eHvB53O4RghAwkBuoOcF.fbSFs2r2Qh8T.j8rq', '12345', 'app/user/1697083523-CNc4Y.png', '2023-10-12 04:05:57', '2023-10-11 21:05:57'),
('9a594e7c-8e35-4ab7-86c9-e78bbbe54d3d', 'Pelaku Usaha', 'admin', '$2y$10$6Wyxn0wIlm8vJAY88PuPTewFh/.tAsF.9sPdk/sfWSFY8B9eIg7Wi', '12345', 'app/user/1697083595-ZPHEN.png', '2023-10-11 21:06:35', '2023-10-11 21:06:35'),
('9a59ac33-85ee-4e96-930a-f9c7d2a4799c', 'Dinas', 'admin', '$2y$10$mdpwjR1FmRsGC1cY.Wrnh.W5s6/T2XS6iYJRiXQ25lEGlpDdZ.7Xa', '12345', 'app/user/1697099315-Yo7MM.png', '2023-10-18 12:37:40', '2023-10-18 05:37:40');
...
CREATE TABLE `desa_wisata` (
  `id` char(36) NOT NULL,
  `nama_desa_wisata` varchar(255) NOT NULL,
  `deskripsi` text,
...
('9a65a2df-8f6e-4797-8c93-47ef3e4f80f4', 'Dinas Pariwisata KKU', 'dinas', '$2y$10$Q8DHRONDzGznyuLtuMHbyeAjlU5M8iXejCT39ttTeQHHvt6SJNb8C', '123', 'Jl. Kota Karang Sutera, Kecamatan Sukadana, Kabupaten Kayong Utara, Kalimantan Barat', '096545345364', 'app/Dinas/1697613148-xytSS.jpg', '2023-10-18 00:12:29', '2023-10-18 00:19:22');
...
('998e81be-61e5-474f-9832-4ccb9df88c9d', 'Wisata Budaya dan Religi', '2023-10-13 04:19:18', '2023-10-12 21:19:18'),
('99a5138d-f1cc-43f9-9393-3c15a57f4286', 'Wisata Buatan', '2023-10-13 04:19:30', '2023-10-12 21:19:30');
...
CREATE TABLE `mitra` (
  `id` char(36) NOT NULL,
  `nama` varchar(255) NOT NULL,
  `kategori` enum('Pengelola Wisata','Pelaku Usaha','Pengelola Taman Nasional') NOT NULL,
  `username` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `confirmasi_password` varchar(255) NOT NULL,
  `alamat` varchar(255) NOT NULL,
...
INSERT INTO `mitra` (`id`, `nama`, `kategori`, `username`, `password`, `confirmasi_password`, `alamat`, `nomor_telpon`, `foto`, `created_at`, `updated_at`) VALUES
('9a65a2df-8f6e-4797-8c93-47ef3e4f80f4', 'Desa Gunung Sembilan', 'Pengelola Wisata', 'gunung', '$2y$10$67bo3q5zfDMQ2Hd4ctGcvejSifwOGhZFLnJJ5Ph2MorxKG8I0CzG6', 'gunung', 'Jl. Kota Karang Sutera, Kecamatan Sukadana, Kabupaten Kayong Utara, Kalimantan Barat', '096545345364', 'app/Mitra/1697634782-wrvmM.jpg', '2023-10-18 00:12:29', '2023-10-18 06:13:03');
