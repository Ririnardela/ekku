...
class FasilitasController extends Controller
{
    ...
    public function create($kategorifasilitas)
    {
        ...
        return view('dinas.fasilitas.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('dinas/fasilitas/' . $id_kategori_fasilitas)->with('success', 'Data Berhasil Disimpan');
    }
    ...
    public function edit($fasilitas)
    {
        ...
        return view('dinas.fasilitas.edit', $data);
    }
    ...
    public function detail($fasilitas)
    {
        ...
        return view('dinas.fasilitas.detail', $data);
    }
