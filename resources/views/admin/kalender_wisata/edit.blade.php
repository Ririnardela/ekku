                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/kalender-wisata', $kalender_wisata->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="lat" value="{{ $kalender_wisata->lat }}">
                            </div>
                            <label class="col-sm-2 col-form-label text-left"> Titik Longitude</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="lng" value="{{ $kalender_wisata->lng }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label text-left">Foto</label>
                            <div class="col-md-2">
                                <img src="{{ url("public/$kalender_wisata->foto2") }}" alt="" height="100"
                                            class="rounded">
                            </div>
                            <div class="col-sm-2">
                                <input type="file" class="form-control" name="foto2" accept=".jpg, .png, .jpeg" value="{{ $kalender_wisata->foto2 }}">
                            </div>
                        </div>
