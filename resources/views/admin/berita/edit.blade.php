                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/berita', $berita->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <img src="{{ url("public/$berita->poto") }}" style="width: 50%" class="avatar-img rounded">
                            </div>
                            <div class="col-sm-4">
                                <input type="file" name="poto" value="{{$berita->poto}}" accept=".png, .jpg, .jpeg" class="form-control">
                            </div>
                        </div>
