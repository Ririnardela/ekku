        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <x-layout.button.back-button url="mitra/taman-nasional" />

                    <h3 class="text-center">Tambah Data Taman Nasional</h3>
                </div>
                <div class="card-body">

                    <form action="{{ url('mitra/taman-nasional') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="text" name="id_mitra" value="{{ Auth::guard('mitra')->user()->id }}" hidden>
