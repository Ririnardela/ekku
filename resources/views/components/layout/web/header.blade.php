<nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav on no-full no-border corporate">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <div class="logo">
                <a href="#">
                    <img class="logo logo-display" src="{{ url('public/web/assets/images/ekku11.png') }}"
                         width="300" height="200" alt="logo-display">
                    <img class="logo logo-scrolled" src="{{ url('public/web/assets/images/ekku12.png') }}"
                         width="300" height="200" alt="logo-scrolled">
                </a>
            </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="nav navbar-nav" data-in="fadeIn" data-out="fadeOut">
                <li><a class="page-scroll" href="{{ url('taman') }}">Taman Nasional</a></li>
                ...
                <li><a class="page-scroll" href="{{ url('kalender-wisata') }}" strong style="font-size: 16px; font-weight:bold;">Event</a></li>
